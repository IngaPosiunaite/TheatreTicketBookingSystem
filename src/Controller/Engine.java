...
//					.getText("Please enter Yes to view all shows. Please enter Quit to leave the program");
				...
				if (currentBasket.getTotal() > 0) {
					...
					if ((inputNY).equals("y")) // customer pay now
					{
						while (c.getIsLogin() == false) {
							// System.out.println(
							// "We do not have your information , if you like to create account please go
							// back to the main menu by insert 0");
//							System.out.println("if you like to continue without create account, please insert 1");
//							System.out.println(" 1 - continue without create account");
//							System.out.println(" 0 - back to main menu");
			...
			if (command.equals("Browse")) {
				...
				// System.out.println("input not not recognized, please check and try again");
			}
