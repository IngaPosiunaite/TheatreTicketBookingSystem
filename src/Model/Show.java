...
public abstract class Show {
	...
	protected String showDate; // test04
	protected String showTime; // test04
	// protected int PerformanceID;
	protected String PerformanceName;
	protected String ShowID;
	protected String PerformanceDescription;
	protected int showDuration; // unit in minutes
	...
	// protected int PerformanceTicketPrice;
...
private void setShowID()
{
	...
	public void sendShowsToDB() {
		...
		//show ID should auto catch from DB, do not input
		//String sql = "INSERT INTO shows (showID, name, type, description, length, time, date, stallPrice, circlePrice, language, liveMusic)"
		//		+ "VALUES (";
		//sql = sql + ShowID;//
		//sql = sql + ", '";
		sql = sql + titleOfShow; //
	...
	void ticketCreate(int numberOfCircleSeats, int numberOfStallSeats, float stallPrice, float circlePrice) throws SQLException {
